...
## CRUD
### Create
Found a new Hanzi out in the wild and want to add it to your list? Simply tap the "+" button, fill in the details you want to add and show off your calligraphy skills by drawing your own custom image for it, or take the easy way out and import an image from your device!
### Read
...
### Update
Feel like your handwriting improved and want to give the drawing another try? Or maybe you discovered a new definition? Tap the UPDATE button from the detailed view of a character and edit any field you see fit.
### Delete
